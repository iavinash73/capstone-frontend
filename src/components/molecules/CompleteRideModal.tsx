// src/components/molecules/CompleteRideModal.tsx
...
import FeedbackForm from "../molecules/FeedbackForm"; // Import the FeedbackForm
  ...
  const handleCompleteRide = async () => {
    ...
    try {
      ...
      if (response?.status === 200) {
        ...
        setShowFeedbackForm(true); // Show the feedback form after ride completion
      } else {
